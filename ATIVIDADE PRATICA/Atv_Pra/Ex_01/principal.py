...
class Principal:
    ...
    def executar_calculos(self):
        ...
        while True:
            ...
            #CONDICIONAL COM AS OPÇOES ESCOLHIDAS E SUAS DEVIDAS OPREÇÃOES
            if op == '1':
                ...
                while True:
                    num1 = input("DIGITE O PENÚLTIMO NÚMERO DO SEU RU: ")
                    if num1.isdigit():
                        num1 = int(num1)
                        break
                    else:
                ...
                while True:
                    num2 = input("DIGITE O ÚLTIMO NÚMERO DO SEU RU: ")
                    if num2.isdigit():
                        num2 = int(num2)
                        break
                    else:
            ...
            if op == '5':
                ...
                print("***OPERAÇÃO DE EXPONENCIAÇÃO SELECIONADA ***")
                print("***DIGITE OS DOIS ÚLTIMOS NÚMEROS DO SEU RU***")
            ...
            if op == '6':
                ...
                print("***OPERAÇÃO DE MÓDULO(RESTO) SELECIONADA ***")
                print("***DIGITE OS DOIS ÚLTIMOS NÚMEROS DO SEU RU***")
            ...
            if op == '7':
                ...
                print("***OPERAÇÃO DE RAIZ QUADRADA SELECIONADA ***")
                print("***DIGITE OS DOIS ÚLTIMOS NÚMEROS DO SEU RU***")
